...
public class ParsingABNews {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "abnews";
        String resourceFullName = "Агентство Бизнес Новостей";
        String resourceShortName = "АБН";
        String resourceLink = "https://abnews.ru/";
        String resourceNewsLink = "https://abnews.ru/feed/";
