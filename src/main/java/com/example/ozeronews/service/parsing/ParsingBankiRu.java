...
public class ParsingBankiRu {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "bankiru";
        String resourceFullName = "Banki.Ru";
        String resourceShortName = "Banki.Ru";
        String resourceLink = "https://www.banki.ru/";
        String resourceNewsLink = "https://www.banki.ru/xml/news.rss";
