...
public class ParsingEnterHub {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "enterhub";
        String resourceFullName = "Enter Hub";
        String resourceShortName = "Enter Hub";
        String resourceLink = "https://enterhub.ru/";
        String resourceNewsLink = "https://enterhub.ru/feed/";
        ...
        try {
            ...
            for (int i = 0; i < articleCollectionCount; i++) {
                ...
                if (!docArticleDescription.getElementsByTag("div").select(".single-post").first()
                        .getElementsByTag("img").select(".img-fluid").isEmpty()) {
                    articleImage = docArticleDescription.getElementsByTag("div").select(".single-post").first()
                            .getElementsByTag("img").select(".img-fluid").first().attr("data-src");
                }
