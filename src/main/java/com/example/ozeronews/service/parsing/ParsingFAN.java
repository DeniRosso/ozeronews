...
public class ParsingFAN {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "fan";
        String resourceFullName = "Федеральное агентство новостей";
        String resourceShortName = "ФАН";
        String resourceLink = "https://riafan.ru/";
        String resourceNewsLink = "https://riafan.ru/feed";
...
//                }
                ...
                List<SyndContent> contents = feed.getEntries().get(i).getContents();
                if (contents != null) {
                    for (SyndContent content : contents) {
                        articleImage =  content.getValue().substring(content.getValue().indexOf("src=\"") + 5);
