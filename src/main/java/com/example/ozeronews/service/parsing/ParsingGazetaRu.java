...
public class ParsingGazetaRu {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "gazetaru";
        String resourceFullName = "Газета.Ру";
        String resourceShortName = "Газета.Ру";
        String resourceLink = "https://www.gazeta.ru/";
        String resourceNewsLink = "https://www.gazeta.ru/export/rss/lenta.xml";
