...
public class ParsingKinoLexx {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "kinolexx";
        String resourceFullName = "KinoLexx";
        String resourceShortName = "KinoLexx";
        String resourceLink = "https://kinolexx.ru/";
        String resourceNewsLink = "https://kinolexx.ru/rss/";
