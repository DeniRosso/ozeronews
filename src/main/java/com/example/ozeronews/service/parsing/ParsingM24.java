...
public class ParsingM24 {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "m24";
        String resourceFullName = "Москва 24";
        String resourceShortName = "Москва 24";
        String resourceLink = "https://www.m24.ru/";
        String resourceNewsLink = "https://www.m24.ru/yandex.xml";
