...
public class ParsingMBK {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "mbk";
        String resourceFullName = "МБХ Медиа";
        String resourceShortName = "МБХ Медиа";
        String resourceLink = "https://mbk-news.appspot.com/";
        String resourceNewsLink = "https://mbk-news.appspot.com/feed/";
