...
@Component
public class ParsingMarketMedia {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "marketmedia";
        String resourceFullName = "Market Media";
        String resourceShortName = "Market Media";
        String resourceLink = "https://marketmedia.ru/";
        String resourceNewsLink = "https://marketmedia.ru/rss/";
        ...
        try {
            ...
            for (int i = 0; i < articleCollectionCount; i++) {
                ...
                articleNumber = articleLink.substring(0, articleLink.length() - 1);
                articleNumber = articleNumber.substring(articleNumber.lastIndexOf("/") + 1);
                articleNumber = resourceKey + "_" +
                        (articleNumber.length() > 33 ?  articleNumber.substring(0, 33) : articleNumber);
