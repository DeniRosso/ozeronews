...
public class ParsingNewsru {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "newsru";
        String resourceFullName = "Newru.com";
        String resourceShortName = "Newru.com";
        String resourceLink = "https://www.newsru.com/";
        String resourceNewsLink = "https://rss.newsru.com/all_news";
        ...
        try {
            ...
            for (int i = 0; i < articleCollectionCount; i++) {
                ...
                articleNumber = resourceKey + "_" +
                        articleLink.substring(articleLink.lastIndexOf("/") + 1, articleLink.indexOf(".html"));
...
//                }
                ...
                if (!docArticleDescription.select("img[class=article-img]").isEmpty()) {
                    Elements articleDescription = docArticleDescription.select("img[class=article-img]");
                    articleImage = articleDescription.select("img[class=article-img]").first().attr("src");
                }
//                System.out.println("articleImage = " + articleImage);

//                Elements articleDescription = docArticleDescription.getElementsByClass("content-main");
//                if (articleDescription != null) {
//                    if (articleDescription.select("img[class=article-img]").first().attr("src") == null) {
//                        articleImage = null;
//                    } else {
//                        articleImage = articleDescription.select("img[class=article-img]").first().attr("src");
//                    }
