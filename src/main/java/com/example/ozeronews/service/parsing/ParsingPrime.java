...
public class ParsingPrime {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "prime";
        String resourceFullName = "ПРАЙМ";
        String resourceShortName = "ПРАЙМ";
        String resourceLink = "https://1prime.ru/";
        String resourceNewsLink = "https://1prime.ru/export/rss2/index.xml";
...
//                System.out.println("feed.getEntries().get(i) = \n" + feed.getEntries().get(i));
////                feed.getEntries().get(i).getModule(DCModuleImpl.);
//
//                List<Module> modules = feed.getEntries().get(i).getModules();
//                if (modules != null) {
