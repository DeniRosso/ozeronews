...
public class ParsingRegnum {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "regnum";
        String resourceFullName = "ИА Regnum";
        String resourceShortName = "ИА Regnum";
        String resourceLink = "https://regnum.ru";
        String resourceNewsLink = "https://regnum.ru/rss/news.html";
        ...
        try {
            ...
            for (int i = 0; i < articleCollectionCount; i++) {
                ...
                articleNumber = resourceKey + "_" +
                        articleLink.substring(articleLink.lastIndexOf("/") + 1, articleLink.lastIndexOf(".html"));
