...
public class ParsingSvoboda {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "svoboda";
        String resourceFullName = "Радио \"Свободы\"";
        String resourceShortName = "Радио \"Свободы\"";
        String resourceLink = "https://www.svoboda.org/";
        String resourceNewsLink = "https://www.svoboda.org/api/z-pqpiev-qpp";
            ...
            for (int i = 0; i < articleCollectionCount; i++) {
                ...
                if(categories!=null) {
                    for(SyndCategory category : categories) {
                        ...
                        if (rubricAliasName.indexOf(" - ") > 0) {
                            rubricAliasName = rubricAliasName.substring(rubricAliasName.indexOf(" - ") + 3);
