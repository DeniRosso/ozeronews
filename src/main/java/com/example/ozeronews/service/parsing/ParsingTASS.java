...
public class ParsingTASS {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "tass";
        String resourceFullName = "ТАСС";
        String resourceShortName = "ТАСС";
        String resourceLink = "https://tass.ru/";
        String resourceNewsLink = "http://tass.ru/rss/v2.xml";
