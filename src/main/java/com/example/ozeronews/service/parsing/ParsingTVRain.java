...
public class ParsingTVRain {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "tvrain";
        String resourceFullName = "Телеканал ДОЖДЬ";
        String resourceShortName = "Телеканал ДОЖДЬ";
        String resourceLink = "https://tvrain.ru/";
        String resourceNewsLink = "https://tvrain.ru/export/rss/all.xml";
        ...
        try {
            ...
            for (int i = 0; i < articleCollectionCount; i++) {
                ...
                articleNumber = resourceKey + "_" + articleLink
                        .substring(articleLink.lastIndexOf("-") + 1, articleLink.indexOf("/?from=rss"));
