...
public class ParsingTopnewsru {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "topnewsru";
        String resourceFullName = "TOP News.RU";
        String resourceShortName = "TOP News.RU";
        String resourceLink = "https://www.topnews.ru/";
        String resourceNewsLink = "https://www.topnews.ru/rss.xml";
        ...
        try {
            ...
            for (int i = 0; i < articleCollectionCount; i++) {
                ...
                articleNumber = resourceKey + "_" + articleLink.substring(
                        articleLink.lastIndexOf("id_") + 3, articleLink.indexOf(".html"));
