...
public class ParsingVC {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "vc";
        String resourceFullName = "VC.RU";
        String resourceShortName = "VC.RU";
        String resourceLink = "https://vc.ru/";
        String resourceNewsLink = "https://vc.ru/rss/new";
