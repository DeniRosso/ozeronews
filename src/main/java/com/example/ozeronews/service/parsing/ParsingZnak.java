...
public class ParsingZnak {
    ...
    public int getArticles() {
        int articleCount = 0;
        String resourceKey = "znak";
        String resourceFullName = "Знак";
        String resourceShortName = "Знак";
        String resourceLink = "https://www.znak.com/";
        String resourceNewsLink = "https://www.znak.com/rss";
